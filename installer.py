...
try:
    ...
    createbottext = ["Now that you're at the developer portal, click \"New Application\" at the top and give it a name.", "On the left panel, click \"Bot\". Then, press \"Add Bot\". Lastly, press \"Yes, do it!\" and give your new Discord bot any name you'd like.", "Once you've created the bot, find \"Privileged Gateway Intents\". Check all three options (\"Presence Intent\", \"Server Members Intent\", and \"Message Content Intent\") and make sure they're enabled.", "Scroll up and find \"Public Bot\". Disable this option.", "On the left panel, click \"OAuth2\", then click \"URL Generator\"", "Select and enable the options \"Bot\" and \"applications.commands\"", "Scroll down and find \"Bot Permissions\". Select the option \"Administrator\"", "Copy the generated URL at the bottom, visit that url in a new tab, and add the bot to the server you just created", "Go back to the developer portal, and press \"Bot\" once again on the left-hand panel. Press \"Reset Token\", then press \"Yes, do it!\". Put in your 2FA code if required.", "Next to the token, press \"Copy\""]
